<section id="aboutEvent" class=".span_12_of_12">
    ...
    <p>Note:</p>
        <ul>
            <li>Watch the weather closely. The show goes on no matter what the weather is doing.</li>
            <li>Remember to bring a change of clothing so you can enjoy the post-event festivities.</li>
        </ul>
